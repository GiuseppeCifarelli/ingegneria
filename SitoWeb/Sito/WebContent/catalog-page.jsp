...
<body>
    ...
    <main class="page catalog-page">
		...
		<tbody>
			...
			<%
			LinkedList<Eventi> listaSportiva = new LinkedList<>();
			listaSportiva = (LinkedList<Eventi>) session.getAttribute("eventiSportivi");
			LinkedList<Eventi> listaMusicale = new LinkedList<>();
			listaMusicale = (LinkedList<Eventi>) session.getAttribute("eventiMusica");
			LinkedList<Eventi> listaSpettacoli = new LinkedList<>();
			listaSpettacoli = (LinkedList<Eventi>) session.getAttribute("eventiSpettacoli");
			
			for(Eventi i : listaSportiva) 
				out.println("<form method = 'GET' name = 'FormEventoSportivo' action = 'InfoEventi'><tr><td><img width='240' height='120'  src="+i.getNomeImmagine()+"></td><td>"+i.getNome()+"</td><td>"+i.getData()+"</td><td><input type = 'hidden' name = 'eventoScelto' value = '"+i.getCodice()+"'><input type = 'hidden' name = 'categoriaEvento' value = 'Sport' ><input type = 'submit' value = 'Ulteriori Informazioni'></td></tr></form>");
			for(Eventi i : listaMusicale) 
				out.println("<form method = 'GET' name = 'FormEventoMusicale' action = 'InfoEventi'><tr><td><img width='240' height='120' src="+i.getNomeImmagine()+"></td><td>"+i.getNome()+"</td><td>"+i.getData()+"</td><td><input type = 'hidden' name = 'eventoScelto' value = '"+i.getCodice()+"'><input type = 'hidden' name = 'categoriaEvento' value = 'Musica' ><input type = 'submit' value = 'Ulteriori Informazioni'></td></tr></form>");
			for(Eventi i : listaSpettacoli) 
				out.println("<form method = 'GET' name = 'FormEventoSpettacolo' action = 'InfoEventi'><tr><td><img width='240' height='120' src="+i.getNomeImmagine()+"></td><td>"+i.getNome()+"</td><td>"+i.getData()+"</td><td><input type = 'hidden' name = 'eventoScelto' value = '"+i.getCodice()+"'><input type = 'hidden' name = 'categoriaEvento' value = 'Spettacolo' ><input type = 'submit' value = 'Ulteriori Informazioni'></td></tr></form>");
			%>
		</tbody>
		</form>
		</table>
