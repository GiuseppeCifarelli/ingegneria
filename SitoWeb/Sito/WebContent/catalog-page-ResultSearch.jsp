...
<body>
    ...
    <main class="page catalog-page">
		...
		<tbody>
			...
			evento = (Eventi) request.getAttribute("risultatoRicerca");
				out.println("<form method = 'GET' name = 'FormEventoSportivo' action = 'InfoEventi'><tr><td><img width='240' height='120'  src="+evento.getNomeImmagine()+"></td><td>"+evento.getNome()+"</td><td>"+evento.getData()+"</td><td><input type = 'hidden' name = 'eventoScelto' value = '"+evento.getCodice()+"'><input type = 'hidden' name = 'categoriaEvento' value = 'Sport' ><input type = 'submit' value = 'Ulteriori Informazioni'></td></tr></form>");
			%>
		</tbody>
		</form>
		</table>
