...
<body>
        ...
        <div class="container"><a class="navbar-brand logo" href="#">Event Manager</a><button class="navbar-toggler" data-toggle="collapse" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse"
                ...
                <ul class="nav navbar-nav ml-auto">
					...
					<%if(session.getAttribute("client") != null) %><li class="nav-item" role="presentation"><a class="nav-link" href="StoricoUtente">Storico Utente</a></li>					<%if(session.getAttribute("client") == null) %><li class="nav-item" role="presentation"><a class="nav-link" href="login.html">Login</a></li>
    ...
    <main class="page catalog-page">
		...
		<tbody>
			...
			lista = (LinkedList<Eventi>) request.getAttribute("lista");
			if(lista.size() == 0) System.out.println("is 0");
			String cat = new String();
			cat = (String) request.getAttribute("categoria");
			if(cat == null) System.out.println("is null");
			else{
				for(Eventi i : lista) 
					out.println("<form method = 'GET' name = 'FormEvento' action = 'InfoEventi'><tr><td><img width='240' height='120'  src="+i.getNomeImmagine()+"></td><td>"+i.getNome()+"</td><td>"+i.getData()+"</td><td><input type = 'hidden' name = 'eventoScelto' value = '"+i.getCodice()+"'><input type = 'hidden' name = 'categoriaEvento' value = '"+cat+"' ><input type = 'submit' value = 'Ulteriori Informazioni'></td></tr></form>");
			}
			%>
		</tbody>
	</form>
