...
/*
 * Il server deve gestire tutte le richieste inerenti al database condiviso in rete, quindi dovr� gestire il multithreading con relative
 ...
 */
	...
	protected int numPort = 5000;//modificare su host altervista	
		...
		Runnable esegui = new Runnable() {
			...
			public void run() {
				...
				try {
					...
					System.out.println("Errore esecuzione del server:" + e.getMessage());
				}				
			}
		};
	...
	public static void main(String[] args) {
		...
		try{
			...
			System.out.println("Errore inizializzazione server:"+ e.getMessage());
		}
	}
}
